...
- [CI ב־db5278c](https://github.com/yuliabk/universal-connection-service/actions/runs/35173287916): כל 565 הבדיקות עברו ללא דילוגים, כולל PostgreSQL 16 ו־Docker; גם בניית wheel וטעינת האפליקציה ממנו עברו. ראיה זו כוללת את ה־runtime ומטריצת הקריסה המוצפנים. rotation באצוות עבר 5 בדיקות SQLite ממוקדות וממתין ל־CI עם PostgreSQL.
