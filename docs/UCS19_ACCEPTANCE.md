...
השלמת הצפנה בשכבת האפליקציה מתקדמת ב־[UCS19_METADATA_ENCRYPTION.md](UCS19_METADATA_ENCRYPTION.md). נוספו primitives ומאגר מסמכים טרנזקציוני מוצפן עם מיגרציה 7; הם אינם מחוברים עדיין ל־StateStore הפעיל. פער ההצפנה נשאר פתוח עד שילוב כל סוגי הנתונים ובדיקות coordinator/קריסה מול האחסון המוצפן.
